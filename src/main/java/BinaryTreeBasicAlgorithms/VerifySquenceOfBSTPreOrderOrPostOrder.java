...
public class VerifySquenceOfBSTPreOrderOrPostOrder {
    ...
    private boolean VerifySquenceOfBSTPostOrder(int[] sequence,int start,int end){
        ...
        boolean left = VerifySquenceOfBSTPostOrder(sequence,start,leftIndex-1);
        boolean right = VerifySquenceOfBSTPostOrder(sequence,leftIndex,end-1);
        return left&&right;
    }
    ...
    private boolean VerifySquenceOfBSTPreOrder(int[] sequence,int start,int end){
        ...
        boolean left = VerifySquenceOfBSTPostOrder(sequence,start+1,leftIndex-1);
        boolean right = VerifySquenceOfBSTPostOrder(sequence,leftIndex,end);
        return left&&right;
    }
